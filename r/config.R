...
# which is a different thing and must not be substituted here.
mb_floodmapping_root   <- .path_default("MBFLOODMAPPING_ROOT",    "D:/Dropbox/ClaudeCode/MBOpenData/MBFloodMapping")
